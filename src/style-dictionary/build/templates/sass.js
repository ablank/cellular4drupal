...
/*
_.each(rm, function(rm_category){

    _.each(cellular, function(prop) {
     if(prop.attributes.category === rm_category) {
   
        console.log(prop);           
   // var {prop, ...dictionary} = allProperties;
    //console.log('\n "PROP":\n'+prop);
          // delete cellular.prop;
     }
