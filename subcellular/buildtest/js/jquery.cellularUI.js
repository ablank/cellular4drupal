        ...
        Drupal.behaviors.cellular = {
            attach: function(context, settings) {
                ...
                cellular.cycle = function(dir) {
                    var $obj = jQuery(this), kids = $obj.children(), count = -1, next;
                    if (dir === "next") {
                        next = kids.next();
                        if (next.length < 1) {
                ...
                cellular.jAccordion = function(opts) {
                    ...
                    fn.showContent = function($li) {
                        if (o.single === true) {
                            $li.siblings(".active").deactivate().find(".panel").slideUp(o.duration, o.easing);
                        } else {
                ...
                cellular.jMmenu = function(opts) {
                    ...
                    var fn = {};
                    fn.classes = [ o.type + "-" + o.direction, o.cclass + "-active", o.cclass + "-inactive" ];
                    fn.mediaQuery = function($obj) {
                        var $parent, classes, $menu = $obj.children([ 0 ]);
                        // console.log($menu);
                        if (window.innerWidth <= o.breakpoint) {
                            $parent = o.parent;
                            classes = [ fn.classes[0], fn.classes[2] ];
                            classes = classes.join(" ");
                            if (o.parent.hasClass(fn.classes[0])) {} else {
                    ...
                    return this.each(function() {
                        ...
                        $obj.click(function() {
                            if (o.parent.hasClass(fn.classes[0])) {
                                o.parent.toggleClass(fn.classes[1]).toggleClass(fn.classes[2]);
                ...
                cellular.jScrolli = function(opts) {
                    ...
                    return this.each(function() {
                        ...
                        $obj.addClass(cellular.opts.cclass).height(maxHeight).once(cellular.opts.cclass, function() {
                            $i.kidWrap();
                        });
                        jQuery(active).activate().fadeIn(o.speed, function() {
                            var $t = jQuery(this);
                            var next = $t.next();
                            if (next.length === 0) {
                                next = $i[0];
                ...
                cellular.jTabs = function(opts) {
                    ...
                    return this.each(function() {
                        ...
                        var tab = $obj.find("> li");
                        var maxHeight = 0;
                        $obj.addClass(cellular.opts.cclass).height(maxHeight);
