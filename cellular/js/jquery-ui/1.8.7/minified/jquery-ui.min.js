...
jQuery.effects || function(b, c) {
    ...
    b.extend(b.effects, {version: "1.8.7", save: function(l, k) {
            ...
            if (l.parent().is(".ui-effects-wrapper"))
                return l.parent();
            var k = {width: l.outerWidth(true), height: l.outerHeight(true), "float": l.css("float")}, m = b("<div></div>").addClass("ui-effects-wrapper").css({fontSize: "100%",
...
(function(b) {
    ...
    b.extend(b.ui.accordion, {version: "1.8.7", animations: {slide: function(c, f) {
...
(function(b, c) {
    ...
    b.extend(b.ui.dialog, {version: "1.8.7", uuid: 0, maxZ: 0, getTitleId: function(e) {
            e = e.attr("id");
            if (!e) {
                this.uuid += 1;
                e = this.uuid
