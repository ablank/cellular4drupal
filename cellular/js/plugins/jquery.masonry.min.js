...
!function(t) {
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var S = e(n.height);
                return S !== !1 && (h.height = S + (E ? 0 : y + b)), h.innerWidth = h.width - (m + _), 
    ...
    i.getListeners = function(t) {
        ...
        r = i.listener.apply(this, e || []), (r === this._getOnceReturnValue() || i.once === !0) && this.removeListener(t, i.listener);
        return this;
    ...
    function i(t, i, n) {
        ...
        var s = n("transition"), a = n("transform"), h = s && a, u = !!n("perspective"), p = {
        ...
        r.prototype._transitionTo = function(t, e) {
            ...
            a = p.isOriginLeft ? a : -a, h = p.isOriginTop ? h : -h, u.transform = c(a, h), 
            this.transition({
                to: u,
            ...
            var r = {};
            if (r.transitionProperty = n.join(","), r.transitionDuration = e, this.element.addEventListener(p, this, !1), 
            ...
            t.target === this.element && (this.removeTransitionStyles(), this.element.removeEventListener(p, this, !1), 
    ...
    "function" == typeof define && define.amd ? define([ "eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property" ], i) : (t.Outlayer = {}, 
    ...
    function r(i, r, p, c, l, m) {
        function y(t, i) {
            if ("string" == typeof t && (t = s.querySelector(t)), !t || !f(t)) return void (a && a.error("Bad " + this.settings.namespace + " element: " + t));
    ...
    var s = t.document, a = t.console, h = t.jQuery, u = function() {}, p = Object.prototype.toString, f = "object" == typeof HTMLElement ? function(t) {
    ...
    function e(t, e) {
        ...
        return n.prototype._resetLayout = function() {
            ...
            this.columnWidth || (this.columnWidth = n ? e(n).outerWidth : this.size.innerWidth), 
            this.columnWidth += this.gutter, this._containerWidth = e(t).innerWidth, this.cols = Math.floor((this._containerWidth + this.gutter) / this.columnWidth), 
