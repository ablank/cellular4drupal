 ...
 */
CKEDITOR.editorConfig=function(a){a.indentClasses=["rteindent1","rteindent2","rteindent3","rteindent4"];
...
a.extraCss="body{min-width: 24em}";/**
   ...
   */
a.bodyClass="";a.bodyId="";/**
   * Sample extraCss code for the "marinelli" theme.
   */
if(Drupal.settings.ckeditor.theme=="marinelli"){a.extraCss+="body{background:#FFF;text-align:left;font-size:0.8em;}";a.extraCss+="#primary ol, #primary ul{margin:10px 0 10px 25px;}"}/**
   * Sample bodyClass and BodyId for the "marinelli" theme.
   */
if(Drupal.settings.ckeditor.theme=="marinelli"){a.bodyClass="singlepage";a.bodyId="primary"}};/*
 * Sample toolbars
 */
