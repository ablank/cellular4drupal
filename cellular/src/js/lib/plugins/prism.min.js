...
!function() {
    var e = /\blang(?:uage)?-(?!\*)(\w+)\b/i, t = self.Prism = {
                ...
                if (f) {
                    ...
                    if (t.hooks.run("before-highlight", l), i && self.Worker) {
                        ...
                        c.onmessage = function(e) {
                            ...
                            l.element.innerHTML = l.highlightedCode, s && s.call(l.element), t.hooks.run("after-highlight", l);
                        }, c.postMessage(JSON.stringify({
                            language: l.language,
                            code: l.code
                        }));
                    } else l.highlightedCode = t.highlight(l.code, l.grammar, l.language), t.hooks.run("before-insert", l), 
                    l.element.innerHTML = l.highlightedCode, s && s.call(r), t.hooks.run("after-highlight", l);
                }
            }
        },
        ...
        tokenize: function(e, n) {
            ...
            e: for (var u in n) if (n.hasOwnProperty(u) && n[u]) {
        ...
        hooks: {
            ...
            run: function(e, n) {
                var r = t.hooks.all[e];
                if (r && r.length) for (var s, i = 0; s = r[i++]; ) s(n);
            }
        }
